...
namespace MauticPlugin\MauticActivemqTransportBundle\Tests\Callback;

use Mautic\SmsBundle\Helper\ContactHelper;
use MauticPlugin\MauticActivemqTransportBundle\Callback\ActivemqCallback;
...
class ActivemqCallbackTest extends TestCase
{
    /**
    ...
    /**
     * @return ActivemqCallback
     */
    private function getCallback()
    {
        return new ActivemqCallback($this->contactHelper);
    }
}
